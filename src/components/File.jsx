  ...
  return (
    <>
      <div className="flex flex-col items-center p-10">
        ...
        <div
          className="flex flex-col items-center gap-4 border-2 border-dashed border-purple-500 rounded-2xl p-8 w-full max-w-[360px] sm:max-w-md bg-white/10 backdrop-blur-lg text-white shadow-lg hover:shadow-[0_0_30px_rgba(56,225,255,0.6)] hover:scale-105 transition-all"
          onDrop={handleDrop}
        ...
        <button
          ...
          className="mt-6 px-8 py-3 rounded-lg font-bold text-white bg-gradient-to-r from-[#0b541e] via-[#499c0a] to-[#6af440] shadow-lg   hover:scale-105 transition-transform duration-200
